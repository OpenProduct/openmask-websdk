...
import { jettonBurnBody, jettonTransferBody } from "./utils";
...
export class JettonWallet extends Contract {
  ...
  createTransferBody = jettonTransferBody;
  createBurnBody = jettonBurnBody;

  async getData() {
    const myAddress = await this.getAddress();
    const dao = new JettonWalletDao(this.provider, myAddress);
    return dao.getData();
  }
}
