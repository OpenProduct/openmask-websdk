 ...
 * @return {Cell}
 */
export const createSmartContractAddressRecord = (
 ...
 * @return {Cell}
 */
export const createAdnlAddressRecord = (adnlAddress: BN) => {
  const cell = new Cell();
 ...
 * @return {Cell}
 */
export const createNextResolverRecord = (smartContractAddress: Address) => {
  const cell = new Cell();
 ...
 * @return {Address|null}
 */
const parseSmartContractAddressImpl = (
  cell: Cell,
  prefix0: number,
  prefix1: number
) => {
 ...
 * @return {Address|null}
 */
export const parseSmartContractAddressRecord = (cell: Cell) => {
 ...
 * @return {Address|null}
 */
export const parseNextResolverRecord = (cell: Cell) => {
 ...
 * @return {Uint8Array}
 */
const domainToBytes = (domain: string) => {
