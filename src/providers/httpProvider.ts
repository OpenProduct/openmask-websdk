...
export class HttpProvider {
     ...
     */
    async getTransactions(address: string, limit: number | undefined = 20, lt: number | undefined = undefined, hash: string | undefined = undefined, to_lt: number | undefined = undefined, archival = undefined) {
     ...
     */
    async getBlockTransactions(workchain: number, shardId: string, shardBlockNumber: number) {
     ...
     * @param shardBlockNumber  {number}
     */
    async getBlockHeader(workchain: number, shardId: string, shardBlockNumber: number) {
