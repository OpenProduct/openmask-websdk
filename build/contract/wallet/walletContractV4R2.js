...
export class WalletV4ContractR2 extends WalletContract {
    ...
    deployAndInstallPlugin = (params) => Contract.createMethod(this.provider, this.deployAndInstallPluginImp(params));
    installPlugin = (params) => Contract.createMethod(this.provider, this.installPluginImp(params));
    getName() {
        return "v4R2";
    }
    /**
