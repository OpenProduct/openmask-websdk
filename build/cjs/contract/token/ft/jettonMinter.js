...
const jettonMinterDao_1 = require("./jettonMinterDao");
class JettonMinter extends contract_1.Contract {
    ...
    createDataCell() {
        ...
        cell.refs[0] = (0, utils_1.createOffchainUriCell)(this.options.jettonContentUri);
        cell.refs[1] = cell_1.Cell.oneFromBoc(this.options.jettonWalletCodeHex);
        return cell;
    }
    /**
    ...
    createMintBody(params) {
        ...
        const transferBody = new cell_1.Cell(); // internal transfer
        ...
        transferBody.bits.writeCoins(new bn_js_1.default(0)); // forward_amount
    ...
    createEditContentBody(params) {
        ...
        body.bits.writeUint(params.queryId || 0, 64); // query_id
        body.refs[0] = (0, utils_1.createOffchainUriCell)(params.jettonContentUri);
        return body;
    }
    async getJettonData() {
        const myAddress = await this.getAddress();
        const dao = new jettonMinterDao_1.JettonMinterDao(this.provider, myAddress);
