...
class Contract {
    ...
    constructor(provider, options) {
        ...
        this.address = options.address ? new address_1.default(options.address) : null;
        if (!options.wc)
    ...
    async createStateInit() {
        ...
        const address = new address_1.default(this.options.wc + ":" + (0, utils_1.bytesToHex)(stateInitHash));
        return {
            stateInit: stateInit,
            address: address,
            code: codeCell,
    ...
    static createInternalMessageHeader(dest, gramValue = 0, ihrDisabled = true, bounce = null, bounced = false, src = null, currencyCollection = null, ihrFees = 0, fwdFees = 0, createdLt = 0, createdAt = 0) {
        ...
        if (!(bounce === null)) {
            ...
            message.bits.writeBit(new address_1.default(dest).isBounceable);
        }
        message.bits.writeBit(bounced);
        message.bits.writeAddress(src ? new address_1.default(src) : null);
        message.bits.writeAddress(new address_1.default(dest));
    ...
    static createMethod(provider, queryPromise) {
        return {
            ...
            send: async () => {
                ...
                const boc = (0, utils_1.bytesToBase64)(await query.message.toBoc(false));
            ...
            estimateFee: async () => {
                ...
                const serialized = query.code && query.data // deploy
                    ? {
                        ...
                        body: (0, utils_1.bytesToBase64)(await query.body.toBoc(false)),
                        init_code: (0, utils_1.bytesToBase64)(await query.code.toBoc(false)),
                        init_data: (0, utils_1.bytesToBase64)(await query.data.toBoc(false)),
                    }
                    : {
