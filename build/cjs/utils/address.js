...
exports.Address = exports.parseFriendlyAddress = void 0;
...
function parseFriendlyAddress(addressString) {
    ...
    const data = (0, utils_1.stringToBytes)((0, utils_1.base64toString)(addressString));
    if (data.length !== 36) {
    ...
    const calcedCrc = (0, utils_1.crc16)(addr);
...
exports.parseFriendlyAddress = parseFriendlyAddress;
class Address {
    /**
    ...
    constructor(anyForm) {
        ...
        if (anyForm.indexOf(":") > -1) {
            ...
            this.isUserFriendly = false;
            this.wc = wc;
            this.hashPart = (0, utils_1.hexToBytes)(hex);
            this.isTestOnly = false;
            this.isBounceable = false;
        }
        else {
    ...
    toString(isUserFriendly, isUrlSafe, isBounceable, isTestOnly) {
        ...
        if (!isUserFriendly) {
            return this.wc + ":" + (0, utils_1.bytesToHex)(this.hashPart);
        }
        else {
            ...
            addressWithChecksum.set((0, utils_1.crc16)(addr), 34);
            // TODO: CHECK
            const params = new Uint8Array(addressWithChecksum);
            let addressBase64 = (0, utils_1.stringToBase64)(String.fromCharCode.apply(null, params));
            if (isUrlSafe) {
