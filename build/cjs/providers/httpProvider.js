...
exports.TonHttpProvider = void 0;
const bn_js_1 = __importDefault(require("bn.js"));
const httpProviderUtils_1 = require("./httpProviderUtils");
const SHARD_ID_ALL = "-9223372036854775808"; // 0x8000000000000000
class TonHttpProvider {
    ...
    getContractState = async (address) => {
        ...
        let balance = new bn_js_1.default(info.balance);
    ...
    async call2(address, method, params = []) {
        ...
        return httpProviderUtils_1.TonHttpProviderUtils.parseResponse(result);
    }
    /**
...
exports.TonHttpProvider = TonHttpProvider;
exports.default = TonHttpProvider;
